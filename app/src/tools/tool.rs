...
pub trait Tool {
    ...
    fn on_pointer_click(&mut self, _pointer_click: PointerEvent, _context: EditorContext) {}
    fn on_pointer_move(&mut self, _pointer_motion: PointerEvent, _context: EditorContext) {}
